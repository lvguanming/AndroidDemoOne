...
public class MainView extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		{	@Override
			...
			{	showPopupWindow (MainView.this,mRightBtn);
			}
		  });*/
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getRepeatCount() == 0) {  //获取 back键
            ...
            if(menu_display){         //如果 Menu已经打开 ，先关闭Menu
                ...
                intent.setClass(MainView.this,Exit.class);
    ...
    public void btnmainright(View v) {
        Intent intent = new Intent (MainView.this,MainTopRightDialog.class);
        startActivity(intent);
        //Toast.makeText(getApplicationContext(), "点击了功能按钮", Toast.LENGTH_LONG).show();
    }
    public void startchat(View v) {      //小黑  对话界面
        Intent intent = new Intent (MainView.this,ChatActivity.class);
        startActivity(intent);
        //Toast.makeText(getApplicationContext(), "登录成功", Toast.LENGTH_LONG).show();
    }
    public void exit_settings(View v) {                           //退出  伪“对话框”，其实是一个activity
        Intent intent = new Intent (MainView.this,ExitFromSettings.class);
        startActivity(intent);
    }
    public void btn_shake(View v) {                                   //手机摇一摇
        Intent intent = new Intent (MainView.this,ShakeActivity.class);
        startActivity(intent);
    }
